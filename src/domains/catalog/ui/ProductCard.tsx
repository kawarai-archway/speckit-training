    ...
    <div className="rounded-lg border border-base-900/10 bg-white p-4 shadow-sm">
      ...
      {onAddToCart && (
        <button
          ...
          className="mt-4 w-full rounded-md bg-base-900 px-4 py-2 text-sm font-medium text-base-50 hover:bg-base-900/90 focus:outline-none focus:ring-2 focus:ring-base-900 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
        >
          カートに追加
        </button>
      )}
